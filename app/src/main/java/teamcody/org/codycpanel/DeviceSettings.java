...
import teamcody.org.codycpanel.util.Constants;
import teamcody.org.codycpanel.util.CMDProcessor;
import teamcody.org.codycpanel.util.Helpers;
...
public class DeviceSettings extends PreferenceActivity implements Preference.OnPreferenceChangeListener, Constants{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        */
        ...
        if (mygetTheme() == android.R.style.Theme_Holo) {
